...
class ChatLlmDisabledIntegrationTest {

    @Autowired
    private MockMvc mockMvc;

    @Test
    void shouldFallbackToRetrievalOnlyAnswerWhenLlmIsDisabled() throws Exception {
        ...
        mockMvc.perform(post("/api/chat/stream")
                        ...
                        .content("""
                                {"threadId":"thread-disabled-llm","message":"warranty period"}
                                """))
                .andExpect(status().isOk())
